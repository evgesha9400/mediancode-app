...
def build_input_api(
            ...
            if isinstance(member, ScalarMember):
                ...
                if field:
                    ...
                    input_field = InputField(
                        name=_scalar_member_field_name(field),
    ...
    for endpoint in api.endpoints:
        ...
        input_endpoints.append(
            InputEndpoint(
                name=_build_endpoint_name(endpoint.method, endpoint.path),
                path=endpoint.path,
...
def _build_path_params(endpoint, fields_map: dict[str, FieldModel]):
    ...
    for param in endpoint.path_params:
        field = fields_map.get(param.get("fieldId"))
