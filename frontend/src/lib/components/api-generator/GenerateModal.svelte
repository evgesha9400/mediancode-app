<script lang="ts">
  ...
  import {
    ...
    modalFooterBtnPrimaryDisabled,
    modalFooterBtnPrimaryEnabled,
  ...
  <div class="p-6">
    ...
    <div class="flex justify-end space-x-2">
      ...
      <button
        ...
        disabled={generating}
        class="{modalFooterBtnPrimary} {generating ? modalFooterBtnPrimaryDisabled : modalFooterBtnPrimaryEnabled}"
      >
        {#if generating}
